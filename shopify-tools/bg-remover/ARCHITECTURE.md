...
- **Secrets Managed:**
  ...
  - `REMBG_API_KEY`
- **Secret Access:** Mounted directly into Cloud Functions environment variables at container startup (`secretKeyRef`).
...
└── bg-remover/
    ...
    └── tests/
        ...
        ├── test_webhooks.py             # Webhook receiver & HMAC unit tests
